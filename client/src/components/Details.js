        ...
        <div className="add_btn">
          ...
          <div className="row">
            <div className="left_view col-lg-6 col-md-6 col-12">
              <img src="C:\Users\user\project\crudapp\img\W_profile.png" style={{ width: 50 }} alt="profile" />
            ...
            <div className="right_view col-lg-6 col-md-6 col-12">
              <p className="mt-5"><StayCurrentPortraitIcon /> Mobile : <span>010-4444-5555</span></p>
